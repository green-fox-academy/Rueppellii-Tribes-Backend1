...
public class ApplicationUserServiceTest {
    ...
    public void saveUserIfValidReturnsNullIfUsernameMissing() {
        assertNull(applicationUserService.saveUserIfValid(new ApplicationUser("", "password", "john@john.com")));
    }

    @Test
    public void saveUserIfValidReturnsNullIfPasswordMissing() {
        assertNull(applicationUserService.saveUserIfValid(new ApplicationUser("John", "", "john@john.com")));
    }
    ...
    public void findByUsername() {
        Mockito.when(applicationUserRepository.findByUsername("John")).thenReturn(Optional.of(testUser));
        assertEquals(testUser, applicationUserService.findByUsername("John"));
    }
}